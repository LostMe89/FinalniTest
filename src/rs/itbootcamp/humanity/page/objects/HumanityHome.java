...
public class HumanityHome {
	...
	public static final String START_TRAIL_CORNER = "//a[@class='button pale']"; // xpath for corner button
	...
	public static final String START_TRAIL = "//input[@id='free-trial-link-01']";// xpath for down button
	...
	//StartFreeTrail in Corner
	public static WebElement getStartFreeTrailCorner(WebDriver driver) {
		return driver.findElement(By.xpath(START_TRAIL_CORNER));
	}
	public static void clickStartFreeTrailCorner(WebDriver driver) {
		getStartFreeTrailCorner(driver).click();
	}
	//StartFreeTrail on page
	//FullName
	
	public static WebElement getFullNameOnPage(WebDriver driver) {
		return driver.findElement(By.xpath(FULL_NAME_XPATH));
	}
	public static void clickFullNameOnPage(WebDriver driver) {
		getFullNameOnPage(driver).click();
	}
	public static void InputFullNameOnPage(WebDriver driver, String data) {
		getFullNameOnPage(driver).sendKeys(data);
	...
	public static WebElement getStartTrailDown(WebDriver driver) {
			return driver.findElement(By.xpath(START_TRAIL));
		}
